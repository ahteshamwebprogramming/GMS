...
function initDates() {
    ...
    $("#AddGuestForm").find('[name="MemberDetail.Pax"]').on("propertychange change keyup paste input", function () {
        $("#AddGuestForm").find('[name="MemberDetail.NoOfRooms"]').val($("#AddGuestForm").find('[name="MemberDetail.Pax"]').val());
    });
    $("#AddGuestForm").find('[name="MemberDetail.AdditionalNights"]').on("propertychange change keyup paste input", function () {
        FetchDepartureDate($("#AddGuestForm").find('[name="MemberDetail.DateOfArrival"]').val(), "AN");
    });
    $("#AddGuestForm").find('[name="MemberDetail.DateOfArrival"]').change(function () {
        FetchDepartureDate($(this).val(), "AD");
    });
    $("#AddGuestForm").find('[name="MemberDetail.ServiceId"]').change(function () {
        FetchDepartureDate($("#AddGuestForm").find('[name="MemberDetail.DateOfArrival"]').val(), "NN");
    });
    $("#AddGuestForm").find('[name="MemberDetail.PickUpDrop"]').change(function () {
        if ($(this).val() == 1) {
            $('#divddlPickUp').show();
            $('#divddlCarType').hide();
    ...
    $("#AddGuestForm").find('[name="MemberDetail.PickUpType"]').change(function () {
        if ($(this).val() == 2) {
            $('#divddlCarType').show();
    ...
    $("#AddGuestForm").find('[name="MemberDetail.GuarenteeCode"]').change(function () {
        FetchPaymentStatus($(this).val());
    });
    $("#AddGuestForm").find('[name="MemberDetail.PaymentStatus"]').change(function () {
        if ($(this).val() == 1) {
    ...
    $("#AddGuestForm").find('#ddlWantToSharePhoto').change(function () {
        if ($(this).val() == "false")
            $('#divUploadPhoto').hide();
    ...
    $("#AddGuestForm").find('[name="MemberDetail.Idproof"]').on("propertychange change keyup paste input", function () {
        if ($("#AddGuestForm").find('[name="MemberDetail.Idproof"]').val().length > 0)
            $('#divUploadIdProofDetails').show();
        else
            $('#divUploadIdProofDetails').hide();
    });
    $("#AddGuestForm").find('[name="MemberDetail.PassportNo"]').on("propertychange change keyup paste input", function () {
        if ($("#AddGuestForm").find('[name="MemberDetail.PassportNo"]').val().length > 0)
            $('#divUploadPassportDetails').show();
        else
            $('#divUploadPassportDetails').hide();
    });
    $("#AddGuestForm").find('[name="MemberDetail.VisaDetails"]').on("propertychange change keyup paste input", function () {
        if ($("#AddGuestForm").find('[name="MemberDetail.VisaDetails"]').val().length > 0)
    ...
    $("#AddGuestForm").find('[name="MemberDetail.NationalityId"]').change(function () {
        let nationality = $("#AddGuestForm").find("[name='MemberDetail.NationalityId'] option:selected").text();

        if (nationality == "Indian") {
            $("#AddGuestForm").find("[name='MemberDetail.Idproof']").parent().find('label').addClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.Idproof']").addClass('requiredInput');
            ...
            $("#AddGuestForm").find("[name='MemberDetail.PassportNo']").parent().find('label').removeClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.PassportNo']").removeClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.PassportIssueDate']").parent().find('label').removeClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.PassportIssueDate']").removeClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.PassportExpiryDate']").parent().find('label').removeClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.PassportExpiryDate']").removeClass('requiredInput');

            $("#AddGuestForm").find("[name='MemberDetail.VisaDetails']").parent().find('label').removeClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.VisaDetails']").removeClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.VisaIssueDate']").parent().find('label').removeClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.VisaIssueDate']").removeClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.VisaExpiryDate']").parent().find('label').removeClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.VisaExpiryDate']").removeClass('requiredInput');
        }
        else {
            $("#AddGuestForm").find("[name='MemberDetail.Idproof']").parent().find('label').removeClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.Idproof']").removeClass('requiredInput');
            ...
            $("#AddGuestForm").find("[name='MemberDetail.PassportNo']").parent().find('label').addClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.PassportNo']").addClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.PassportIssueDate']").parent().find('label').addClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.PassportIssueDate']").addClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.PassportExpiryDate']").parent().find('label').addClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.PassportExpiryDate']").addClass('requiredInput');

            $("#AddGuestForm").find("[name='MemberDetail.VisaDetails']").parent().find('label').addClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.VisaDetails']").addClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.VisaIssueDate']").parent().find('label').addClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.VisaIssueDate']").addClass('requiredInput');
            $("#AddGuestForm").find("[name='MemberDetail.VisaExpiryDate']").parent().find('label').addClass('required');
            $("#AddGuestForm").find("[name='MemberDetail.VisaExpiryDate']").addClass('requiredInput');
        }

    });

    $("#AddGuestForm").find('#ddlWantToSharePhoto').change();
    $("#AddGuestForm").find('[name="MemberDetail.Idproof"]').change();
    $("#AddGuestForm").find('[name="MemberDetail.PassportNo"]').change();
    $("#AddGuestForm").find('[name="MemberDetail.VisaDetails"]').change();
    $("#AddGuestForm").find('[name="MemberDetail.NationalityId"]').change();
}

function getOnLoadAddGuests() {
    CalculateAge();
    $("#AddGuestForm").find('[name="MemberDetail.PickUpDrop"]').change();
    $("#AddGuestForm").find('[name="MemberDetail.PickUpLoaction"]').change();
    $("#AddGuestForm").find('[name="MemberDetail.GuarenteeCode"]').change();
    $("#AddGuestForm").find('[name="MemberDetail.PaymentStatus"]').change();
...
function GuestsListPartialView(PageNumber = 1) {
    let GuestsListType = $("#AddGuestForm").find("#GuestsListType").val();
    if (GuestsListType == "") {
        GuestsListType = "Current";
    }
    let SearchKeyword = $("#AddGuestForm").find("#GuestsSearchKeyword").val();
    var inputDTO = {};
...
function AddGuestsPartialView(GroupId = '', PAXSno = 1) {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            $('#div_AddGuestsListPartial').html(data);
            $("#btnModelAddGuests").click();
            $("#AddGuestForm").find("[name='MemberDetail.PAXSno']").val(PAXSno);
            $("#AddGuestForm").find("[name='spnPAXSno']").text(PAXSno);
            initDates();
            getOnLoadAddGuests();
            initValidateRoomsAvailability();
            $("#AddGuestForm").find("[name='MemberDetail.CountryId']").change();
            $("#AddGuestForm").find("[name='MemberDetail.CatId']").change();

            GetRoomRatesForEnquiry();
...
function InitialiseMobileFields() {
    ...
    var txtmobile = $("#AddGuestForm").find("[name='MemberDetail.MobileNo']")[0]; // get raw DOM element
...
function GetServices_New(serviceId) {
    let minNight = $("#AddGuestForm").find("[name='MemberDetail.CatId'] option:selected").attr('minNight');
    let maxNight = $("#AddGuestForm").find("[name='MemberDetail.CatId'] option:selected").attr('maxNight');
    let price = $("#AddGuestForm").find("[name='MemberDetail.CatId'] option:selected").attr('price');
...
function FetchDepartureDate(ArrivalDate, Source) {
    ...
    if ($("#AddGuestForm").find('[name="MemberDetail.ServiceId"]').val() == "" || $("#AddGuestForm").find('[name="MemberDetail.ServiceId"]').val() == null || $("#AddGuestForm").find('[name="MemberDetail.ServiceId"]').val() == undefined || $("#AddGuestForm").find('[name="MemberDetail.ServiceId"]').val() == "0") {
        $erroralert("Package not found!", 'Please select select package first!');
        //alert("Please select select services first", "error");
        $("#AddGuestForm").find('[name="MemberDetail.ServiceId"]').focus();
        $("#AddGuestForm").find('[name="MemberDetail.DateOfArrival"]').val('');
        return false;
    }
    if ($("#AddGuestForm").find('[name="MemberDetail.AdditionalNights"]').val() == "" || $("#AddGuestForm").find('[name="MemberDetail.AdditionalNights"]').val() == null || $("#AddGuestForm").find('[name="MemberDetail.AdditionalNights"]').val() == undefined || $("#AddGuestForm").find('[name="MemberDetail.AdditionalNights"]').val() == "0") {
        AdditionalNights = 0;
    }
    else
        AdditionalNights = $("#AddGuestForm").find('[name="MemberDetail.AdditionalNights"]').val();

    let NoOfNights = $("#AddGuestForm").find('[name="MemberDetail.ServiceId"]').val();
    ...
    $("#AddGuestForm").find('[name="MemberDetail.DateOfDepartment"]').val(departureDate.format("DD-MM-YYYY"));
    $("#AddGuestForm").find('[name="TimeOfDepartment"]').val("11:00")
    //var inputDTO = {};
