function isValidateForm(formId) {
    ...
    formElements.each(function () {
        ...
        if (Array.isArray(value)) {
            value = value.filter(v => v.trim() !== ""); // Remove empty values
        }
        // Check if the value is invalid
        //if (value === "" || value === null || value === undefined  || value === "0" || value === "Choose option" || value.toUpperCase() === "SELECT" || value.toUpperCase() === "--SELECT--") {
        if (value === "" || value === null || value === undefined || (Array.isArray(value) && value.length === 0) || (!Array.isArray(value) && (value === "0" || value === "Choose option" || value.toUpperCase() === "SELECT" || value.toUpperCase() === "--SELECT--"))
        ) {
            isValid = false;
