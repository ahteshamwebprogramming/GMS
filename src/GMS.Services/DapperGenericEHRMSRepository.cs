...
public class DapperGenericEHRMSRepository<T> : IDapperEHRMSRepository<T> where T : class, new()
{
    protected IDbConnection DbConnection { get; private set; }
    private readonly DapperEHRMSDBContext _dapperDBContext;
    private readonly SqlConnection _connection;
    string strConnection;
    public DapperGenericEHRMSRepository(DapperEHRMSDBContext dapperDBContext)
    {
        _dapperDBContext = dapperDBContext;
        DbConnection = dapperDBContext.CreateConnection();
        _connection = new SqlConnection("Data Source=182.18.138.110;Initial Catalog=EHRMS;User ID=sa;Password=CG$sBK9%!8P4c$;Encrypt=False;");
    }
